...
function orderedExtractInObject(parent, values) {
  return [omitUndefined(orderedPick(parent, values)), omitUndefined((0, _lodash3.default)(parent, values))];
}
/**
 *
...
function extractInObject(parent, values) {
  return [omitUndefined((0, _pick.default)(parent, values)), omitUndefined((0, _lodash3.default)(parent, values))];
}
...
const platformSpecificSpaceUnits = theme => {
  ...
  scales.forEach(key => {
    const scale = (0, _lodash4.default)(theme, key, {});
